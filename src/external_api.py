...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("../logs/external_api.log"), logging.StreamHandler()],
    encoding="utf-8",
)
...
def get_exchange_rate(currency):
    """Получает ответ от API о курсе валют"""
...
if __name__ == "__main__":  # pragma: no cover
    ...
    convert_transaction({"operationAmount": {"amount": "100.50", "currency": {"code": "USD"}}})
