import pytest
from generators.generators import filter_by_carrency,transaction_descriptions

def test_filter_by_carrency(test_tranzact_list):

    """  тест фильтрации данных  """

    res_ = list(test_filter_by_carrency(test_tranzact_list))
...
def test_transaction_descriptions(tranzact_list,transaction_descriptions):
